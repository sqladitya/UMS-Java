...
public class StudentFeeForm extends JFrame implements ActionListener{
    ...
    StudentFeeForm(){
        ...
        lblrollnumber.setBounds(40,60,120,20);
        ...
        lblfname.setBounds(40,140,150,30);
        lblfname.setFont(new Font("Tahoma",Font.BOLD,16));
        add(lblfname);
        
        JLabel labelfname = new JLabel();
        labelfname.setBounds(200,140,150,30);
        ...
        String course[] = {"BTech","BSc","BBA","MTech","MSc","BCA","Bcom","Mcom","MBA"};
        ...
        String semester[]={"Semester1","Semester2","Semeste3","Semester4","Semester5","Semester6","Semester7","Semester8"};
